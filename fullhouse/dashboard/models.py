...
# - I've created alright __str__ methods, but feel free to change them to suit
#   you
# - Because we use the related_name argument when defining foreign keys, you can
#   access UserProfiles and Announcements through House objects. For example:
