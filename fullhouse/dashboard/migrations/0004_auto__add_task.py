...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Task'
        db.create_table('dashboard_task', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks_created', to=orm['dashboard.UserProfile'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('house', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks', to=orm['dashboard.House'])),
            ('assigned', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks_assigned', to=orm['dashboard.UserProfile'])),
            ('due', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('dashboard', ['Task'])


    def backwards(self, orm):
        # Deleting model 'Task'
        db.delete_table('dashboard_task')
    ...
    models = {
        ...
        'dashboard.task': {
            ...
            'assigned': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tasks_assigned'", 'to': "orm['dashboard.UserProfile']"}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tasks_created'", 'to': "orm['dashboard.UserProfile']"}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'due': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
