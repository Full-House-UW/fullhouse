...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'House.zip_code'
        db.alter_column('dashboard_house', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=9, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'House.zip_code'
        raise RuntimeError("Cannot reverse this migration. 'House.zip_code' and its values cannot be restored.")
