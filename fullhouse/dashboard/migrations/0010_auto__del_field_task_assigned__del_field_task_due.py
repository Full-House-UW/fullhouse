...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('dashboard_task', 'assigned_id')

        # Deleting field 'Task.due'
        db.delete_column('dashboard_task', 'due')


    def backwards(self, orm):
        # Adding field 'Task.assigned'
        db.add_column('dashboard_task', 'assigned',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='old_tasks_assigned', null=True, to=orm['dashboard.UserProfile'], blank=True),
                      keep_default=False)

        # Adding field 'Task.due'
        db.add_column('dashboard_task', 'due',
