...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('dashboard_announcement', 'title')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Announcement.title'
        raise RuntimeError("Cannot reverse this migration. 'Announcement.title' and its values cannot be restored.")
