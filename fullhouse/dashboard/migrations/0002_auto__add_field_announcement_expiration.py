...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Announcement.expiration'
        db.add_column('dashboard_announcement', 'expiration',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Announcement.expiration'
        db.delete_column('dashboard_announcement', 'expiration')
